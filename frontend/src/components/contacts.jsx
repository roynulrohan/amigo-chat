        ...
        <div className='contacts'>
            <div className='contact d-flex justify-content-between align-items-center p-3'>
                <div className='d-flex flex-column justify-content-between'>
                    ...
                    <small className='id'>a7a6d7a6dw7aad</small>
                </div>
                <a className='button btn btn-danger rounded-pill text-dark text-center p-2'>
                    <svg
            ...
            <div className='contact d-flex justify-content-between align-items-center p-3'>
                <div className='d-flex flex-column justify-content-between'>
                    ...
                    <small className='id'>b6va698d8sa96d8s</small>
                </div>
                <a className='button btn btn-danger rounded-pill text-dark text-center p-2'>
                    <svg
                        xmlns='http://www.w3.org/2000/svg'
